...
@section('body')
    ...
    <div class="container">
        <div class="checkout-sidebar-price-table mt-30">
            ...
            <form action="{{route('update.hotel.booking')}}" method="POST">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-12 form-input form">
                        <input type="number" name="payment_price" value="{{$data->payment_price}}" min="0" class="form-control" placeholder="Enter amount" required>
                    </div>
                </div>
