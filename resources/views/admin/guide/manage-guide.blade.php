        ...
        <div class="col-7 align-self-center text-end">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb justify-content-end">
                    ...
                    <li class="breadcrumb-item active">Manage Tour Guide</li>
                </ol>
                ...
                <table id="config-table" class="table display table-striped border no-wrap">
                    ...
                    @foreach($guides as $guide)
                        <tr>
                            ...
                            <td><img src="{{asset($guide->image)}}" height="70px" width="70px" alt=""></td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{route('edit.guide',['id'=>$guide->id])}}" class="btn btn-sm btn-primary me-4"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
