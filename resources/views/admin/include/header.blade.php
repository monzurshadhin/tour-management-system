        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="">
                <!-- Logo icon --><b>
                    ...
                    <!-- Dark Logo icon -->
{{--                    <img src="{{asset('/')}}admin/assets/images/logo-icon.png" alt="homepage" height="60px" width="80px" class="dark-logo" />--}}
                    <!-- Light Logo icon -->
{{--                    <img src="{{asset('/')}}admin/assets/images/logo-icon.png" alt="homepage" height="60px" width="80px"   class="light-logo" />--}}
                </b>
                <!--End Logo icon -->
                <!-- Logo text --><span>
                         <!-- dark Logo text -->
