...
@section('body')
    ...
    <div class="card">
        <div class="card-body">
            <h4 class="card-title text-center my-4">Manage Hotel</h4>
                ...
                <table id="config-table" class="table display table-striped border no-wrap">
                    ...
                    @foreach($hotels as $hotel)
                        <tr>
                            ...
                            <td>{{$hotel->room_price}} TK</td>
                            <td>{{$hotel->location_name}}</td>
                            <td>{{$hotel->description}}</td>
                            <td><img src="{{asset($hotel->image)}}" height="70px" width="70px" alt=""></td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{route('edit.hotel',['id'=>$hotel->id])}}" class="btn btn-sm btn-primary me-4"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
